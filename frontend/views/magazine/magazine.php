		...
		<div class="col-md-12 page-magazine p-y-2">
					<div class="container">
						<div class="title">
							...
							<div class="description">Простой способ создать популярный интернет-магазин для вашего бизнеса</div>
						</div>
					...
					<div class="container p-y-2">
						<div class="row params">
							<a href="#" class="item col-md-3">
								...
								<div class="title">Собственный интернет-магазин с Вашими товарами</div>
							</a>
							<a href="#" class="item col-md-3">
								<div class="icon"><img src="/images/icon-market2.png"></div>
								<div class="title">Возможность рекламировать избранные товары</div>
							</a>
							<a href="#" class="item col-md-3">
								<div class="icon"><img src="/images/icon-market3.png"></div>
								<div class="title">Персональный консультант для Вашего бизнеса</div>
							</a>
							<a href="#" class="item col-md-3">
								<div class="icon"><img src="/images/icon-market4.png"></div>
								<div class="title">Возможность осуществлять покупки онлайн</div>
							</a>
						</div>
					</div>
				</div>
				...
				<div class="background">
					<div class="container p-y-2">
					<div class="title mb-15-15">Тарифные планы</div>

					<div class="fleft tariff">
						<div class="item">
							<div class="name"></div>
							<div class="count">Количество товаров</div>
							<div class="days">Срочный товар</div>
							<div class="days">ТОП на 30 дней</div>
							<div class="days">Дополнительные товары, <br>за штуку</div>
							<div class="check">Стандартный дизайн</div>
							<div class="check">Возможность применить<br> индивидуальный дизайн</div>
							<div class="check">Персональный консультант</div>
					...
					<div class="row tariff">
						...
						<div class="item <?php if(!empty(Yii::$app->request->post('Magazine')['tarif_plan'])){if(Yii::$app->request->post('Magazine')['tarif_plan'] == $val['id']){echo 'active';}}else if($val['id'] == 1) {echo 'active';} ?>" data-id="<?= $val['id'] ?>">
							...
							<div class=" days-fire"><?= $val[$sub][0]['fire'] ?></div>
							<div class="days"><?= $val[$sub][0]['top_30_day'] ?></div>
							<div class=" dop_tov">
								<span class="span-dop"><?= $val[$sub][0]['dop_tov'] ?></span>
								 грн
							</div>
							<div class="check"><i class="fa fa-<?php if(intval($val[$sub][0]['design']) === 1) echo 'check'; else echo 'close'; ?>" aria-hidden="true"></i></div>
							<div class="check ind_desing"><span class="span-ind-des">
								
								+<?= intval($val[$sub][0]['ind_design']) ?>
								
								</span> грн
							</div>
							<div class="check per_consult"><i class="fa fa-<?php if(intval($val[$sub][0]['per_consult']) === 1) echo 'check'; else echo 'close'; ?>" aria-hidden="true"></i></div>
							<div class="price price-relative">
								<span class="line-through"></span>
								<?php if(intval($val[$sub][0]['old_price']) != 0): ?>
								<span class="span-old-price"><?= intval($val[$sub][0]['old_price']) ?></span>
								<?php endif; ?>
							</div>
					...
					<?= Html::submitButton('Далее', ['class' => 'btn j-primary']) ?>
